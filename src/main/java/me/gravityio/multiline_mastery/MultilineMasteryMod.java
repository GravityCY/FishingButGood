    ...
    *///?} else {
    ...
    //?}
        ...
        if (BuiltInLootTables.FISHING_TREASURE.equals(key)) {
            ...
            //? if >=1.21 {
            /*Versioned.addToLootable(pool, registries, SEAFARERS_FORTUNE_KEY, ConstantValue.exactly(1), (item) -> item.setWeight(40));
            Versioned.addToLootable(pool, registries, MULTILINE_MASTERY_KEY, ConstantValue.exactly(1), (item) -> item.setWeight(20));
            Versioned.addToLootable(pool, registries, SEAFARERS_FORTUNE_KEY, UniformGenerator.between(2, 3), (item) -> item.setWeight(6));
            Versioned.addToLootable(pool, registries, MULTILINE_MASTERY_KEY, UniformGenerator.between(2, 3), (item) -> item.setWeight(3));
            *///?} else {
            ...
            //? if >=1.21 {
            /*Versioned.addToLootable(pool, registries, SEAFARERS_FORTUNE_KEY, ConstantValue.exactly(1), item -> item.setWeight(2));
            Versioned.addToLootable(pool, registries, MULTILINE_MASTERY_KEY, ConstantValue.exactly(1), item -> item.setWeight(1));
            *///?} else {
